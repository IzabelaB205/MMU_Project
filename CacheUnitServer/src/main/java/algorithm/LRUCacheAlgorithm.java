...
public class LRUCacheAlgorithm<K,V> implements ICacheAlgorithm<K,V>{
    private final int size;
    private List<K> usageOrder;
    private Map<K, V> cache;

    public LRUCacheAlgorithm(int size) {
        this.size = size;
    ...
    public V putElement(K key, V value) {
        ...
        // 1. remove page from the linked list and map
        ...
        // if the cache is full - remove the least recently used page
            ...
            K removedKey = usageOrder.remove(0);
